...
//     // Use the file name and encode it for safe URL usage
...
//             'https://c06677dwsl.execute-api.us-east-1.amazonaws.com/dev/getDP1status',
//             {
//               method: 'POST',
//               headers: {
//                 'Content-Type': 'application/json',
...
//             throw new Error('Error fetching processing status');
//           }
...
//             // setProcessedFileUrl(statusData.referenceId); // Assume referenceId contains the file download URL
